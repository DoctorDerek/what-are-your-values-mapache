...
export default function SeethingSwarmBattleStage({
  ...
  return (
    <div
      className="relative flex min-h-0 min-w-0 flex-1 flex-col [--battle-arena-height:calc(var(--battle-combatant-size)+4rem)] [--battle-combatant-scale:1] [--battle-combatant-size:calc(var(--battle-tile-size)*var(--battle-combatant-scale))] xl:flex-row xl:[--battle-combatant-scale:2]"
